...
func TestTerraformLambdaExample(t *testing.T) {
	...
	assert.Contains(t, planOut, "module.cf.aws_cloudfront_distribution.this will be created")
	assert.Contains(t, planOut, "module.cf.aws_cloudfront_origin_access_identity.this will be created")
